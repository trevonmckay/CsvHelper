...
{
	/// <summary>
	/// Configuration used for reading and writing data.
	/// </summary>
	public class FileConfiguration : IReaderConfiguration, IWriterConfiguration
	{
		...
		public FileConfiguration(CultureInfo cultureInfo)
		{
